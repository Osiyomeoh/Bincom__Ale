...
CREATE TABLE `lga` (
  ...
  `lga_description` text DEFAULT NULL,
  `entered_by_user` varchar(50) NOT NULL,
  `date_entered` datetime NOT NULL,
  `user_ip_address` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `new_polling_unit`
--

CREATE TABLE `new_polling_unit` (
  `id` int(11) NOT NULL,
  `party_name` varchar(30) NOT NULL,
  `party_result` varchar(30) NOT NULL,
...
CREATE TABLE `ward` (
  ...
  `ward_name` varchar(50) NOT NULL,
  `lga_id` int(11) NOT NULL,
  `ward_description` text DEFAULT NULL,
  `entered_by_user` varchar(50) NOT NULL,
  `date_entered` datetime NOT NULL,
  `user_ip_address` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexes for table `new_polling_unit`
--
ALTER TABLE `new_polling_unit`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `new_polling_unit`
--
ALTER TABLE `new_polling_unit`
